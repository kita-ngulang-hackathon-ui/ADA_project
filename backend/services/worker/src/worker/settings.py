...
class WorkerSettings(BaseSettings):
    ...
    # Provider-specific JSON merged into the chat-completions body. Qwen3 needs
    # {"chat_template_kwargs": {"enable_thinking": false}} to stop the model
    # emitting a <think> block, whose invented numbers the validator rejects.
    explain_llm_extra_body: dict[str, Any] = Field(default_factory=dict)
